...
let blockWidth = 88;
let blockHeight = 30;
let blockColumns = 12;  // Increased the number of columns
let blockRows = 5;      // Increased the number of rows
let blockMaxRows = 10;
let blockCount = 0;
...
blockImage.src = '../GAME_IMAGES/brick.png';

// Set the dimensions after the image has loaded
blockImage.onload = function() {
    blockImage.width = '20px';
    blockImage.height = '5px';
};
...
function update() {
    ...
    // Inside the update function, where game over message is drawn
        ...
        context.fillText("You Missed it! Press Space to restart", 300, 420);
        gameOver = true;
    }
    ...
    context.fillText("SCORE: " + score, 10, 25); // Concatenate "SCORE: " with the score
}
